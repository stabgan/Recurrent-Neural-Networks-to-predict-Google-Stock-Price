...
# Variant: 20 timesteps, 1 LSTM layer
...
regressor.add(LSTM(units=3, input_shape=(X_train.shape[1], 1)))
...
plt.title('Google Stock Price Prediction (20 timesteps, 1 LSTM layer)')
plt.xlabel('Time')
